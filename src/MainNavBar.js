...
if(sessionStorage.getItem('user')){
    ...
    const url=`https://pehnaway67.000webhostapp.com/orderapi/post/read_single.php?id=${b.id}`;
...
axios.post('https://pehnaway67.000webhostapp.com/orderapi/post/delete.php/ ',formData,config)
.then(response=>{console.log(response)})
var a=  document.getElementsByClassName('fa-window-close')[0]
          ...
          <div className="col-lg-2 col-md-3 col-sm-3 col-3 ">
            <ul className="userbagul mt-lg-5 ">
              ...
              <li className="userbagli">
               ...
               onMouseEnter={this.registereddiv} onTouchStart={this.registereddiv} ></i></Link>
...
<div className="userregistered" onMouseLeave={this.registereddivclose}s>
