...
class UI extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      quanity:'',
      sale:'',
      coverImg:localStorage.getItem('coverImg')
  ...
  img = (img, name, code, brand, color, material, price, type, category_name, size_type,quanity,sale) => {
    this.setState({
      img: img,
      name: name,
      code: code,
          ...
          <div className='row'>
            ...
            <div className="col-lg-3 col-md-12 filterbycolumn" id="filterbycolumnid"  >
              ...
              <ul className="filterbylist">
                ...
                <hr></hr>
                <li onClick={() => this.func('material', 'lawn')}>Lawn</li>
                <hr></hr>
                <li onClick={() => this.func('material', 'cambric')}>Cambric</li>
                <hr></hr>
            ...
            <div className='row'>
            <div className='col ' >
              <img src={this.state.coverImg} className="topImage"></img>
              <h1 className="headingOnCover">{this.state.brands[0].brand}</h1>
            </div>
          </div>
              ...
              <div className='row  pr-4 mt-0 '  >
                ...
                <div className=' col-md-2 col-3  mt-4 filterbuttoncol' id='filterbuttoncolid'    >
                  <button type="button" className="filterbutton filbut btn btn-light" id='filterbuttonid' onClick={this.openFilter}>Filter</button>
                </div>
              </div>
                ...
                <div className="row mr-lg-1"  >
                  {
                    ...
                    this.state.catg && rows1 === 0 ? (
                      ...
                      <i class="fa fa-bell" aria-hidden="true"></i> No results found of this selection
