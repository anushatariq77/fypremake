...
class SignUp extends Component {
    ...
    componentDidMount(){
        ...
        if(sessionStorage.getItem('user')){
           ...
           axios.get(`https://pehnaway67.000webhostapp.com/orderapi/post/read_single.php?id=${a.id}`)
     ...
     console.log(this.state.address)
        ...
        var a = document.getElementsByClassName("loadercheck")[0];
                        ...
                        if( ((this.state.payment!==""&& this.state.address!=="")&&(this.state.address!==""||this.state.payment!==""))){
                            axios.post('https://pehnaway67.000webhostapp.com/orderapi/post/update.php',formData,config)
